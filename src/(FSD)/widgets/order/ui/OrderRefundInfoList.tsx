...
import { useOrderRefundListRead } from "@/(FSD)/entities/order/api/useOrderRefundListRead";

const OrderRefundInfoList = () => {
    const { orderList, fetchNextPage, refetch, hasNextPage } = useOrderRefundListRead();
...
export default OrderRefundInfoList;